...
public class CoarseLockCalculation implements Runnable {

	private int threadId;
	private Map<String, StationRecord> stations = new HashMap<String, StationRecord>();
	private List<String> lines = new ArrayList<String>();

	public CoarseLockCalculation(int threadId, Map<String, StationRecord> stations, List<String> lines) {
	...
	public void run() {
		...
		for (String line : lines) {
			...
			// [TODO] Check minimum enclosed area!
